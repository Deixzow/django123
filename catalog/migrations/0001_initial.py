# Generated by Django 3.0.3 on 2020-10-30 08:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief desription of the book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Enter the book's natural language (e.g. English, French)", max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Weapon',
            fields=[
                ...
                ('skill', models.CharField(help_text='Enter a desription of the skill.', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Role',
            fields=[
                ...
                ('summ', models.TextField(help_text='Enter a brief desription of the role.', max_length=1000)),
                ('weapon', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.Weapon')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
