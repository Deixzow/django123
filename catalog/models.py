...
class Genre(models.Model):
    '''Model representinig a book genre'''
...
class Role(models.Model):
    ...
    summ = models.TextField(max_length=1000, help_text='Enter a brief desription of the role.')
...
class Weapon(models.Model):
    ...
    skill = models.CharField(max_length=200, help_text="Enter a desription of the skill.")
